...
def main():
    ...
    # Select one image (let's pick one from the middle)
    selected_image = images[500]  # covid_121.png or similar
    ...
    fig.suptitle(f'XAI Methods for COVID-19 X-Ray Classification\n'
